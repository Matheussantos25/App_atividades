...
def adicionar_exercicio():
    ...
    with col2:
        tipo_exercicio = st.selectbox("Escolha o tipo de exercício:", [
            'flexões', 'abdominal bicicleta','agachamento', 'corrida', 'pular corda', 'andar de bicicleta', 'prancha', 'Elevação de joelhos na barra fixa','barra sem peso', 'barra com peso'
        ])
